...
import { type TLoginFormSchema } from '@/schemas/formSchema';
...
function LoginForm({ className, ...props }: React.ComponentProps<'div'>) {
  const { mutate } = useApiMutation<{ message: string }, TLoginFormSchema>(
    'POST',
    `${import.meta.env.VITE_SPRING_BASE_URL}/login`,
    {
