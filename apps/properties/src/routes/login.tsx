...
import { type TLoginFormSchema, loginFormSchema } from '@/schemas/formSchema';
...
function LoginForm({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  const { Field, handleSubmit } = useForm({
    ...
    onSubmit: ({ value }) => {
      console.log(`Submitted: ${value.email} ${value.password}`);
      mutate(value);
    },
  });
              ...
              >
                <div className="flex flex-col gap-6">
                  ...
                  <div className="text-center text-sm">
                    ...
                    <Link
                      to="/signup"
                      className="underline underline-offset-4 cursor-pointer hover:text-primary/75"
                    >
                      Sign up
                    </Link>
                  </div>
